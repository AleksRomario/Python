...
WIDTH = 640
HEIGHT = 480 
WINDOW_TITLE = "ISAAC Movement"
WHITE = (255, 255, 255)

FPS = 60 

ISAAC_WIDTH , ISAAC_HEIGHT = 100 , 115
ISAAC_SPEED = 2

# ISSAC_GHOST_IMAGE = pygame.image.load(os.path.join('img', 'issac_ghost.png'))
